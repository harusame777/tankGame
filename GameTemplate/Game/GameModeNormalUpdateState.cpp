...
void GameModeNormalUpdateState::Update()
{
	...
	m_testDirectionalLight.SetColor(0.5f, 0.5f, 0.5f);
	m_testDirectionalLight.SetDirection(0.0, 1.0f, 0.0f);
	...
	m_testDirectionalLight.VPCamSetPosition({ 2000.0f, 2000.0f, 2000.0f });
